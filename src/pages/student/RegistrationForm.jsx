...
import { studentRegistrationValidationSchema } from "../../schemaValidation";
import { Gender } from "../../../src/utils/enums";
import DateInput from "../../components/form-components/DateInput";
import { Modal, Paper } from "@mui/material";
import CustomizedSnackbars from "../../components/SnackBar/SuccessSnackBar";
...
const RegisterationForm = () => {
  ...
  const handleRegistration = (values, formikBag) => {
    console.log({ values });
  };
